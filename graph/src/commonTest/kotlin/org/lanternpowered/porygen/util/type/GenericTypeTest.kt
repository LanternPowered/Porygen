...
class GenericTypeTest {
  ...
  fun test() {
    ...
    assertTrue(genericTypeOf<NoiseQuality>().isSubtypeOf<Enum<*>>())
    assertTrue(genericTypeOf<MyExtendingClass>().isSubtypeOf<MyAbstractClass>())
  }

  abstract class MyAbstractClass
  class MyExtendingClass : MyAbstractClass()
}
