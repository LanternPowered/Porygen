 ...
 */
package org.lanternpowered.porygen.graph.type.map
...
object CellMapType : NodeType("map/cell map", "Cell Map") {
  ...
  val chunkSize = property("chunk size", Vector2i(16, 16))
  val sectionSize = property("section size", Vector2i(512, 512))
